...
public class ApkParsers {
    ...
    /**
     * Use BouncyCastle instead of JSSE to parse X509 certificate. If want to use BouncyCastle, you will also need to add bcprov and bcpkix lib to your project.
     */
