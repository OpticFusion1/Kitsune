...
public class LibraryHeader extends ChunkHeader {
    ...
    /**
     * A package-id to package name mapping for any shared libraries used in this resource table. The package-id's encoded in this resource table may be different than the id's assigned at runtime. We must be able to translate the package-id's based on the package name.
     */
    /**
