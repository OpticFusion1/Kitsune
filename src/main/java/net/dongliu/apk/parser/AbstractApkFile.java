...
public abstract class AbstractApkFile implements Closeable {
    ...
    /**
     * Get the apk's all certificates. For each entry, the key is certificate file path in apk file, the value is the certificates info of the certificate file.
     *
     * @deprecated use {{@link #getApkSingers()}} instead
     */
    @Deprecated
    ...
    /**
     * Get the apk's all cert file info, of apk v1 signing. If cert faile not exist, return empty list.
     */
    ...
    /**
     * Get the apk's all signer in apk sign block, using apk singing v2 scheme. If apk v2 signing block not exists, return empty list.
     */
    ...
    /**
     * This method return icons specified in android manifest file, application. The icons could be file icon, color icon, or adaptive icon, etc.
     *
     * @return icon files.
     */
    ...
    /**
     * The locale preferred. Will cause getManifestXml / getApkMeta to return different values. The default value is from os default locale setting.
     */
