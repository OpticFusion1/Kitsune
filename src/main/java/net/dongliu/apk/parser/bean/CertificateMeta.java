...
public class CertificateMeta {
    ...
    /**
     * the signature algorithm OID string. An OID is represented by a set of non-negative whole numbers separated by periods. For example, the string "1.2.840.10040.4.3" identifies the SHA-1 with DSA signature algorithm defined in
    ...
    /**
     * first use base64 to encode certificate binary data, and then calculate md5 of base64b string. some programs use this as the certMd5 of certificate
     */
