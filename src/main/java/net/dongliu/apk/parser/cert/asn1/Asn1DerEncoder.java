 ...
 * <p>
 * <p>
 * Structure is described to the encoder by providing a class annotated with {@link Asn1Class}, containing fields annotated with {@link Asn1Field}.
 */
public final class Asn1DerEncoder {
     ...
     *
     * @param container container to be encoded. The container's class must meet the following requirements:
     * <ul>
     * <li>The class must be annotated with {@link Asn1Class}.</li>
     * <li>Member fields of the class which are to be encoded must be annotated with {@link Asn1Field} and be public.</li>
     * </ul>
    ...
    /**
     * Compares two bytes arrays based on their lexicographic order. Corresponding elements of the two arrays are compared in ascending order. Elements at out of range indices are assumed to be smaller than the smallest possible value for an element.
     */
