...
public class BerDataValue {
    ...
    /**
     * Returns the tag class of this data value. See {@link BerEncoding} {@code TAG_CLASS} constants.
     */
    ...
    /**
     * Returns {@code true} if the content octets of this data value are the complete BER encoding of one or more data values, {@code false} if the content octets of this data value directly represent the value.
     */
    ...
    /**
     * Returns the tag number of this data value. See {@link BerEncoding} {@code TAG_NUMBER} constants.
     */
    ...
    /**
     * Returns a new reader which returns just this data value. This may be useful for re-reading this value in different contexts.
     */
