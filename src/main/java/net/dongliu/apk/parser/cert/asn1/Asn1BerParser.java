 ...
 * <p>
 * <p>
 * Structure is described to the parser by providing a class annotated with {@link Asn1Class}, containing fields annotated with {@link Asn1Field}.
 */
public final class Asn1BerParser {
     ...
     *
     * @param encoded encoded input. If the decoding operation succeeds, the position of this buffer is advanced to the first position following the end of the consumed structure.
     * @param containerClass class describing the structure of the input. The class must meet the following requirements:
     * <ul>
     * <li>The class must be annotated with {@link Asn1Class}.</li>
     * <li>The class must expose a public no-arg constructor.</li>
     * <li>Member fields of the class which are populated with parsed input must be annotated with {@link Asn1Field} and be public and non-final.</li>
     * </ul>
     * @throws Asn1DecodingException if the input could not be decoded into the specified Java object
     */
    ...
    /**
     * Returns the implicit {@code SET OF} contained in the provided ASN.1 BER input. Implicit means that this method does not care whether the tag number of this data structure is {@code SET OF} and whether the tag class is {@code UNIVERSAL}.
     * <p>
     * <p>
     * Note: The returned type is {@link List} rather than {@link java.util.Set} because ASN.1 SET may contain duplicate elements.
     *
     * @param encoded encoded input. If the decoding operation succeeds, the position of this buffer is advanced to the first position following the end of the consumed structure.
     * @param elementClass class describing the structure of the values/elements contained in this container. The class must meet the following requirements:
     * <ul>
     * <li>The class must be annotated with {@link Asn1Class}.</li>
     * <li>The class must expose a public no-arg constructor.</li>
     * <li>Member fields of the class which are populated with parsed input must be annotated with {@link Asn1Field} and be public and non-final.</li>
