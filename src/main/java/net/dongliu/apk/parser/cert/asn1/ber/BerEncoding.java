...
public abstract class BerEncoding {
    ...
    /**
     * Returns {@code true} if the provided first identifier byte indicates that the data value uses constructed encoding for its contents, or {@code false} if the data value uses primitive encoding for its contents.
     */
    ...
    /**
     * Returns the tag class encoded in the provided first identifier byte. See {@code TAG_CLASS} constants.
     */
    ...
    /**
     * Returns the tag number encoded in the provided first identifier byte. See {@code TAG_NUMBER} constants.
     */
