...
class AggregateTranslator extends CharSequenceTranslator {
    ...
    /**
     * The first translator to consume codepoints from the input is the 'winner'. Execution stops with the number of consumed codepoints being returned. {@inheritDoc}
     */
    @Override
